...
if not imguicheck or not sampevcheck or not encodingcheck or not lfscheck or not monetluacheck or not doesFileExist('moonloader/Mordor Police Helper/Images/binderblack.png') or not doesFileExist('moonloader/Mordor Police Helper/Images/binderwhite.png') or not doesFileExist('moonloader/Mordor Police Helper/Images/lectionblack.png') or not doesFileExist('moonloader/Mordor Police Helper/Images/lectionwhite.png') or not doesFileExist('moonloader/Mordor Police Helper/Images/settingsblack.png') or not doesFileExist('moonloader/Mordor Police Helper/Images/settingswhite.png') or not doesFileExist('moonloader/Mordor Police Helper/Images/changelogblack.png') or not doesFileExist('moonloader/Mordor Police Helper/Images/changelogwhite.png') or not doesFileExist('moonloader/Mordor Police Helper/Images/departamentblack.png') or not doesFileExist('moonloader/Mordor Police Helper/Images/departamenwhite.png') then
	function main()
		...
		lua_thread.create(function()
			...
			while true do
				if progressbar and progressbar.max ~= 0 and progressbar.downloadinglibname and progressbar.downloaded and progressbar.downloadingtheme then
					...
					renderFontDrawText(ASHfont, 'Mordor Police Helper', x+ 5, y - 37, 0xFFFFFFFF)
		...
		sampAddChatMessage(('[ASHelper]{EBEBEB} Началось скачивание необходимых файлов. Если скачивание не удастся, то обратитесь к {ff6633}vk.com/shepich{ebebeb}.'),0xff6633)
		...
		if not doesFileExist('moonloader/Mordor Police Helper/Images/binderblack.png') or not doesFileExist('moonloader/Mordor Police Helper/Images/binderwhite.png') or not doesFileExist('moonloader/Mordor Police Helper/Images/lectionblack.png') or not doesFileExist('moonloader/Mordor Police Helper/Images/lectionwhite.png') or not doesFileExist('moonloader/Mordor Police Helper/Images/settingsblack.png') or not doesFileExist('moonloader/Mordor Police Helper/Images/settingswhite.png') or not doesFileExist('moonloader/Mordor Police Helper/Images/changelogblack.png') or not doesFileExist('moonloader/Mordor Police Helper/Images/changelogwhite.png') or not doesFileExist('moonloader/Mordor Police Helper/Images/departamentblack.png') or not doesFileExist('moonloader/Mordor Police Helper/Images/departamenwhite.png') then
			print('{FFFF00}Скачивание: PNG Файлов')
			createDirectory('moonloader/Mordor Police Helper')
			createDirectory('moonloader/Mordor Police Helper/Images')
			DownloadFiles({theme = 'PNG Файлов',
				{url = 'https://github.com/Just-Mini/biblioteki/raw/main/Images/binderblack.png', file = 'moonloader/Mordor Police Helper/Images/binderblack.png', name = 'binderblack.png'},
				{url = 'https://github.com/Just-Mini/biblioteki/raw/main/Images/binderwhite.png', file = 'moonloader/Mordor Police Helper/Images/binderwhite.png', name = 'binderwhite.png'},
				{url = 'https://github.com/Just-Mini/biblioteki/raw/main/Images/lectionblack.png', file = 'moonloader/Mordor Police Helper/Images/lectionblack.png', name = 'lectionblack.png'},
				{url = 'https://github.com/Just-Mini/biblioteki/raw/main/Images/lectionwhite.png', file = 'moonloader/Mordor Police Helper/Images/lectionwhite.png', name = 'lectionwhite.png'},
				{url = 'https://github.com/Just-Mini/biblioteki/raw/main/Images/settingsblack.png', file = 'moonloader/Mordor Police Helper/Images/settingsblack.png', name = 'settingsblack.png'},
				{url = 'https://github.com/Just-Mini/biblioteki/raw/main/Images/settingswhite.png', file = 'moonloader/Mordor Police Helper/Images/settingswhite.png', name = 'settingswhite.png'},
				{url = 'https://github.com/Just-Mini/biblioteki/raw/main/Images/departamentblack.png', file = 'moonloader/Mordor Police Helper/Images/departamentblack.png', name = 'departamentblack.png'},
				{url = 'https://github.com/Just-Mini/biblioteki/raw/main/Images/departamenwhite.png', file = 'moonloader/Mordor Police Helper/Images/departamenwhite.png', name = 'departamenwhite.png'},
				{url = 'https://github.com/Just-Mini/biblioteki/raw/main/Images/changelogblack.png', file = 'moonloader/Mordor Police Helper/Images/changelogblack.png', name = 'changelogblack.png'},
				{url = 'https://github.com/Just-Mini/biblioteki/raw/main/Images/changelogwhite.png', file = 'moonloader/Mordor Police Helper/Images/changelogwhite.png', name = 'changelogwhite.png'},
			})
...
local buttons = {
	{name='Настройки',text='Пользователь, вид\nскрипта, цены',icon=fa.ICON_FA_LIGHT_COG,y_hovered=8,timer=1},
	{name='Дополнительно',text='Правила, заметки,\nотыгровки',icon=fa.ICON_FA_FOLDER,y_hovered=8,timer=1},
	{name='Информация',text='Обновления, автор,\nо скрипте',icon=fa.ICON_FA_LIGHT_INFO_CIRCLE,y_hovered=8,timer=1},
}
local fmbuttons = {
...
imgui.OnInitialize(function()
	...
	whiteashelper = imgui.CreateTextureFromFile(getGameDirectory()..'\\moonloader\\Mordor Police Helper\\Images\\settingswhite.png')
	blackashelper = imgui.CreateTextureFromFile(getGameDirectory()..'\\moonloader\\Mordor Police Helper\\Images\\settingsblack.png')
	whitebinder = imgui.CreateTextureFromFile(getGameDirectory()..'\\moonloader\\Mordor Police Helper\\Images\\binderwhite.png')
	blackbinder = imgui.CreateTextureFromFile(getGameDirectory()..'\\moonloader\\Mordor Police Helper\\Images\\binderblack.png')
	whitelection = imgui.CreateTextureFromFile(getGameDirectory()..'\\moonloader\\Mordor Police Helper\\Images\\lectionwhite.png')
	blacklection = imgui.CreateTextureFromFile(getGameDirectory()..'\\moonloader\\Mordor Police Helper\\Images\\lectionblack.png')
	whitedepart = imgui.CreateTextureFromFile(getGameDirectory()..'\\moonloader\\Mordor Police Helper\\Images\\departamenwhite.png')
	blackdepart = imgui.CreateTextureFromFile(getGameDirectory()..'\\moonloader\\Mordor Police Helper\\Images\\departamentblack.png')
	whitechangelog = imgui.CreateTextureFromFile(getGameDirectory()..'\\moonloader\\Mordor Police Helper\\Images\\changelogwhite.png')
	blackchangelog = imgui.CreateTextureFromFile(getGameDirectory()..'\\moonloader\\Mordor Police Helper\\Images\\changelogblack.png')
...
function changePosition(table)
	lua_thread.create(function()
		...
		ChangePos = false
		inicfg.save(configuration,'Mordor Police Helper')
	end)
end
							...
							for k,v in pairs(questions.questions) do
								...
								if questions.active.redact then
									...
									if imgui.Button(fa.ICON_FA_TRASH..'##'..k, imgui.ImVec2(30,30)) then
										...
										local file = io.open(getWorkingDirectory()..'\\Mordor Police Helper\\questions.json', 'w')
					...
					if imgui.BeginPopup(u8'Редактор вопросов', _, imgui.WindowFlags.NoCollapse + imgui.WindowFlags.AlwaysAutoResize) then
						...
						if #str(questionsettings.questionhint) > 0 and #str(questionsettings.questionques) > 0 and #str(questionsettings.questionname) > 0 then
							if imgui.Button(u8'Сохранить####questeditor', imgui.ImVec2(150, 25)) then
								...
								local file = io.open(getWorkingDirectory()..'\\Mordor Police Helper\\userQuestions.json', 'w')
								file:write(encodeJson(questions))
								file:close()
...
local imgui_settings = imgui.OnFrame(
	...
	function(player)
		...
		imgui.Begin(u8'#MainSettingsWindow', windows.imgui_settings, imgui.WindowFlags.NoTitleBar + imgui.WindowFlags.NoResize + imgui.WindowFlags.NoScrollbar + imgui.WindowFlags.NoCollapse)
			...
			imgui.BeginGroup()
				...
				imgui.Hint('lastupdate','От ' .. latestUpdate)
				imgui.PushStyleVarVec2(imgui.StyleVar.WindowPadding, imgui.ImVec2(15,15))
				if imgui.BeginPopupModal(u8'Все команды', _, imgui.WindowFlags.NoCollapse + imgui.WindowFlags.NoScrollbar + imgui.WindowFlags.AlwaysAutoResize + imgui.WindowFlags.NoTitleBar) then
					...
					imgui.BeginGroup()
						imgui.TextColoredRGB('/mph - Главное меню скрипта')
						imgui.TextColoredRGB('/mphbind - Биндер скрипта')
						imgui.TextColoredRGB('/mphlect - Меню лекций скрипта(5+ ранг)')
						imgui.TextColoredRGB('/mphdep - Меню департамента скрипта(5+ ранг)')
							...
							imgui.BeginGroup()
								...
								imgui.BeginGroup()
									if imgui.CircleButton('##choosestyle0', configuration.main_settings.style == 0, imgui.ImVec4(1.00, 0.42, 0.00, 0.53)) then
										configuration.main_settings.style = 0
										inicfg.save(configuration, 'Mordor Police Helper.ini')
										checkstyle()
									end
									imgui.SameLine()
									...
									if imgui.CircleButton('##choosestyle6', configuration.main_settings.style == 6, imgui.GetStyle().Colors[imgui.Col.Button], nil, true) then
										...
										inicfg.save(configuration, 'Mordor Police Helperini')
										checkstyle()
									end
								...
								imgui.BeginGroup()
									...
									if imgui.Button(u8'Сбросить##RCol',imgui.ImVec2(65,25)) then
										...
										if inicfg.save(configuration, 'Mordor Police Helper.ini') then
									...
									imgui.SameLine()
									imgui.Text(u8'Цвет Mordor Police Helper в чате')
									imgui.SameLine(190)
				...
				elseif mainwindow[0] == 2 then
					...
					if additionalwindow[0] == 1 then
						imgui.BeginChild('##rulesswindow',_,false, imgui.WindowFlags.NoScrollbar)
							...
							if imgui.IsMouseReleased(0) and imgui.IsItemHovered() then
								createDirectory(getWorkingDirectory()..'\\Mordor Police Helper\\Rules')
								os.execute('explorer '..getWorkingDirectory()..'\\Mordor Police Helper\\Rules')
							end
							imgui.SetCursorPos(imgui.ImVec2(15, 20))
									...
									if imgui.InvisibleButton('##zametkisave',imgui.ImVec2(85,15)) then
										if #str(zametkisettings.zametkaname) > 0 then
											if #str(zametkisettings.zametkatext) > 0 then
												...
												zametkaredact_number = nil
												local file = io.open(getWorkingDirectory()..'\\Mordor Police Helper\\userNotes.json', 'w')
				...
				elseif mainwindow[0] == 3 then
							...
							if updateinfo.version and updateinfo.version ~= thisScript().version then
								...
								imgui.BeginGroup()
									...
									if imgui.TreeNodeStr(u8'Список изменений') then
										...
										imgui.TextWrapped((updateinfo.change_log))
										imgui.TreePop()
									end
								imgui.EndGroup()
							else
								...
								imgui.BeginGroup()
									...
									if imgui.Button(u8'Проверить наличие обновлений') then
										checkUpdates('https://raw.githubusercontent.com/shep1ch/hell-num_2/main/nicedick.json', true)
									end
								imgui.EndGroup()
							end
							imgui.NewLine()
					...
					elseif infowindow[0] == 2 then
						...
						imgui.BeginGroup()
							...
							imgui.PushFont(font[15])
							imgui.TextColoredRGB('Автор - {MC}Shepi')
							imgui.PopFont()
							imgui.NewLine()
							...
							imgui.SameLine(190)
							imgui.Link('https://vk.com/shepich', u8'VK') imgui.SameLine(); if imgui.Selectable('copy') then setClipboardText('https://vk.com/shepich') end
							...
							imgui.SameLine(190)
							imgui.Link('https://www.donationalerts.com/r/shepich', 'donationalerts.com/r/shepich')
						imgui.EndGroup()
					elseif infowindow[0] == 3 then
						imgui.SetCursorPos(imgui.ImVec2(15,15))
						imgui.BeginGroup()
							imgui.PushFont(font[16])
							imgui.TextColoredRGB('Mordor Police Helper',1)
							imgui.PopFont()
	...
	* Mordor Police Helper - удобный помощник, который облегчит Вам работу в МЮ на Мордор ролевая игра. Обновления скрипта происходят безопасно для Вас, автообновления нет, установку должны подтверждать Вы.
	...
	* Команды сервера с отыгровками - /invite, /uninvite, /giverank, /blacklist, /unblacklist, /fwarn, /unfwarn, /fmute, /funmute. Введя любую из этих команд начнётся РП отыгровка, лишь после неё будет активирована сама команда (эту функцию можно отключить в настройках).

	* Команды хелпера - /mph - настройки хелпера, /mphbind - биндер хелпера, /mphlect - меню лекций, /mphdep - меню департамента

	* Настройки - Введя команду /mph откроются настройки в которых можно изменять никнейм в приветствии, акцент, создание маркера при выделении, пол, цены на лицензии, горячую клавишу быстрого меню и многое другое.

	* Меню лекций - Введя команду /mphlect откроется меню лекций, в котором вы сможете озвучить/добавить/удалить лекции.

	* Биндер - Введя команду /mphbind откроется биндер, в котором вы можете создать абсолютно любой бинд на команду, или же кнопку(и).]])
						imgui.Spacing()
						imgui.EndGroup()
					end
					imgui.EndChild()
				...
				if imgui.Button(u8'Сохранить',imgui.ImVec2(100,30)) then
					...
					if not inprocess then
						...
						if kei ~= nil then
							...
							if inicfg.save(configuration, 'Mordor Police Helper') then
	...
	function(player)
		...
		if #lections.data == 0 then
			...
			if imgui.Button(u8'Восстановить изначальные лекции', imgui.ImVec2(250, 25)) then
				...
				local file = io.open(getWorkingDirectory()..'\\Mordor Police Helper\\userLections.json', 'w')
...
local imgui_database = imgui.OnFrame(
	function() return windows.imgui_database[0] end,
	function(player)
		player.HideCursor = isKeyDown(0x12)
		imgui.SetNextWindowSize(imgui.ImVec2(700, 365), imgui.Cond.FirstUseEver)
		imgui.SetNextWindowPos(imgui.ImVec2(ScreenSizeX * 0.5 , ScreenSizeY * 0.5),imgui.Cond.FirstUseEver, imgui.ImVec2(0.5, 0.5))
		imgui.Begin(u8'#database', windows.imgui_database, imgui.WindowFlags.NoTitleBar + imgui.WindowFlags.NoResize + imgui.WindowFlags.NoCollapse)
		...
		imgui.SameLine(668)
		if imgui.Button(fa.ICON_FA_TIMES,imgui.ImVec2(23,23)) then
			windows.imgui_database[0] = false
		end
		imgui.PopStyleColor(3)

		imgui.BeginChild('##databbuttons',imgui.ImVec2(180,300),true, imgui.WindowFlags.NoScrollbar + imgui.WindowFlags.NoScrollWithMouse)
			imgui.PushItemWidth(150)
			...
			imgui.InputTextWithHint('##toorgnamedep',u8('Организация'),departsettings.toorgname, sizeof(departsettings.toorgname))
				...
				imgui.BeginGroup()
					for i = #changelog.versions, 1 , -1 do
						...
						if changelog.versions[i].patches then
							imgui.Spacing()
							imgui.PushFont(font[16])
							imgui.TextColoredRGB('{25a5db}Улучшения '..(changelog.versions[i].patches.active and '<<' or '>>'))
							imgui.PopFont()
			...
			if notify.msg[k] and notify.msg[k].active then
				...
				if notify.pos.y - i * 21 > 0 then
					...
					imgui.Begin(u8('Notify ##'..k), _, imgui.WindowFlags.NoTitleBar + imgui.WindowFlags.NoResize + imgui.WindowFlags.NoMove + imgui.WindowFlags.NoScrollbar)
						...
						imgui.TextColoredRGB('{MC}Mordor Police Helper')
						imgui.PopFont()
...
function sampev.onShowDialog(dialogId, style, title, button1, button2, text)
	...
	elseif dialogId == 235 and getmyrank then
		if find(text, 'Инструкторы') then
			...
			ASHelperMessage('Вы не работаете в автошколе, скрипт выгружен! Если это ошибка, то обратитесь к {MC}vk.com/shepich{WC}.')
			NoErrors = true
			thisScript():unload()
		end
...
function checkServer(ip)
	local servers = {
		['185.173.93.8:7228'] = 'HackMySoftware',
	}
...
function ASHelperMessage(text)
	...
	text = gsub(text, '{WC}', '{EBEBEB}')
	text = gsub(text, '{MC}', format('{%06X}', bit.bor(bit.bor(b, bit.lshift(g, 8)), bit.lshift(r, 16))))
	sampAddChatMessage(format('[Mordor Police Helper]{EBEBEB}{ffffff}: %s', text),join_argb(a, r, g, b)) -- ff6633 default
end

function onWindowMessage(msg, wparam, lparam)
	if wparam == 0x1B and not isPauseMenuActive() then
		if windows.imgui_settings[0] or windows.imgui_fm[0] or windows.imgui_binder[0] or windows.imgui_lect[0] or windows.imgui_depart[0] or windows.imgui_changelog[0] or windows.imgui_database[0] then
...
function onScriptTerminate(script, quitGame)
	if script == thisScript() then
		...
		sampShowDialog(536472, '{ff6633}[Mordor Police Helper]{ffffff} Скрипт был выгружен.', [[
...
- В папке moonloader > config > Удаляем файл Mordor Police Helper.ini
- В папке moonloader > Удаляем папку Mordor Police Helper
4. Если ничего из вышеперечисленного не исправило ошибку, то следует установить скрипт на другую сборку.
5. Если даже это не помогло Вам, то отправьте автору {2594CC}(vk.com/shepich){FF6633} скриншот ошибки.{FFFFFF}
———————————————————————————————————————————————————————
...
function createJsons()
	createDirectory(getWorkingDirectory()..'\\Mordor Police Helper')
	createDirectory(getWorkingDirectory()..'\\Mordor Police Helper\\Rules')
	if not doesFileExist(getWorkingDirectory()..'\\Mordor Police Helper\\userLections.json') then
		lections = default_lect
		local file = io.open(getWorkingDirectory()..'\\Mordor Police Helper\\userLections.json', 'w')
		file:write(encodeJson(lections))
		file:close()
	else
		local file = io.open(getWorkingDirectory()..'\\Mordor Police Helper\\userLections.json', 'r')
		lections = decodeJson(file:read('*a'))
		file:close()
	end
	if not doesFileExist(getWorkingDirectory()..'\\Mordor Police Helper\\userQuestions.json') then
		questions = {
			active = { redact = false },
			questions = {}
		}
		...
		local file = io.open(getWorkingDirectory()..'\\Mordor Police Helper\\userQuestions.json', 'r')
		questions = decodeJson(file:read('*a'))
		questions.active.redact = false
		file:close()
	end
	if not doesFileExist(getWorkingDirectory()..'\\Mordor Police Helper\\userNotes.json') then
		zametki = {}
		local file = io.open(getWorkingDirectory()..'\\Mordor Police Helper\\userNotes.json', 'w')
		file:write(encodeJson(zametki))
		file:close()
	else
		local file = io.open(getWorkingDirectory()..'\\Mordor Police Helper\\userNotes.json', 'r')
...
function checkRules()
	ruless = {}
	for line in lfs.dir(getWorkingDirectory()..'\\Mordor Police Helper\\Rules') do
		if line == nil then
		elseif line:match('.+%.txt') then
			local temp = io.open(getWorkingDirectory()..'\\Mordor Police Helper\\Rules\\'..line:match('.+%.txt'), 'r+')
			local temptable = {}
	...
	local json_url = 'https://raw.githubusercontent.com/shep1ch/hell-num_2/main/rules.json'
			...
			if doesFileExist(json) then
				...
				if f then
					if info[checkServer(select(1, sampGetCurrentServerAddress()))] then
						...
						ASHelperMessage('Ошибка в импротировании правил сервера! Неизвестный сервер. Обратитесь к {MC}vk.com/shepich{WC}.')
					end
				end
			end
		end
...
function main()
	...
	addNotify(format('Успешная загрузка, версия %s.\nНастроить скрипт: {MC}/mph', thisScript().version), 10)
	...
	sampRegisterChatCommand('mphbind', function()
		choosedslot = nil
		windows.imgui_binder[0] = not windows.imgui_binder[0]
	end)
	sampRegisterChatCommand('mphstats', function()
		ASHelperMessage('Это окно теперь включается в {MC}/mph{WC} - {MC}Настройки{WC}.')
	end)
	sampRegisterChatCommand('mphlect', function()
		if configuration.main_settings.myrankint < 5 then
			return addNotify('Данная функция доступна с 5-го\nранга.', 5)
		end
		windows.imgui_lect[0] = not windows.imgui_lect[0]
	end)
	sampRegisterChatCommand('mphdep', function()
		if configuration.main_settings.myrankint < 5 then
			return addNotify('Данная функция доступна с 5-го\nранга.', 5)
		end
		windows.imgui_depart[0] = not windows.imgui_depart[0]
	end)
	sampRegisterChatCommand('mphdb', function()
		if configuration.main_settings.myrankint < 2 then
			return addNotify('Данная функция доступна со 2-го\nранга.', 5)
		end
		windows.imgui_database[0] = not windows.imgui_database[0]
	end)
	sampRegisterChatCommand('mphupd', function()
	...
	while true do
		...
		if configuration.main_settings.autoupdate and os.clock() - autoupd[0] > 600 then
			checkUpdates('https://raw.githubusercontent.com/shep1ch/hell-num_2/main/nicedick.json')
			autoupd[0] = os.clock()
		end
		wait(0)
	end
	...
	versions = {
		{
			version = '1.0',
			date = '22.01.2022',
			text = {'Релиз (спасибо Just-Mini за помощь в разработке)'},
		},
	},
}
